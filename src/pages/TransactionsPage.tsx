            ...
            <div className="grid gap-3 py-2">
              <div className="relative border-2 border-red-400/30 rounded-xl p-3 bg-white/30">
                 ...
                 {inputTypeMode === 'manual' ? (
                    <div className="relative"><Input ref={manualTypeRef} placeholder="اكتب المعاملة هنا.. (20 حرف كحد أقصى)" value={formData.manualType} onChange={handleManualTypeChange} onKeyDown={(e) => handleKeyDown(e, agentPriceRef)} className="bg-[#eef2f6] shadow-3d-inset border-none h-10 text-sm animate-pulse" /></div>
                 ) : (
